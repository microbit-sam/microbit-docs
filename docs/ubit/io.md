...
>  <div style='color:#008080; display:inline-block'>int</div> *id* - the unique  EventModel  id of this component.

>  <div style='color:#008080; display:inline-block'>PinName</div> *name* - the mbed PinName for this  MicroBitPin  instance.
