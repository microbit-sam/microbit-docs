$(document).ready(function() { $('div[role="main"]').prepend("<div class='admonition warning' style='margin-top:30px;'><p class='admonition-title'>Warning</p><p>You are viewing documentation for <b>v2.1.1</b></p></div>") });
